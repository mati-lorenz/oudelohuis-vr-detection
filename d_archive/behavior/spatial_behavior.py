...
savedir = '/u/g/glorenz/Documents/Research/Code/external_repos/oudelohuis-vr-detection/Figures'
...
for ises,ses in enumerate(sessions):
    ...
    save_fig(fig, os.path.join(savedir,'Spatial','ExampleSessions','RunSpeed_Outcome_%s' % sessions[ises].sessiondata['session_id'][0] + '.png'), format = 'png')
...
for ises,ses in enumerate(sessions):
    ...
    save_fig(fig, os.path.join(savedir,'Spatial','ExampleSessions','LickRate_Outcome_%s' % sessions[ises].sessiondata['session_id'][0] + '.png'), format = 'png')
...
save_fig(fig, os.path.join(savedir,'Performance','LickRate_Outcome_Engaged_%dsessions'  %  nSessions + '.png'), format = 'png')
...
save_fig(fig, os.path.join(savedir,'Performance','Runspeed_Outcome_Engaged_%dsessions' %  nSessions + '.png'), format = 'png')
...
plt.tight_layout()
#Save figure:
save_fig(fig,os.path.join(savedir, 'Spatial', 'RunSpeed_Hist_AllSessions_%dsessions' % nSessions + '.png'), format='png')
...
plt.tight_layout()
#Save figure:
save_fig(fig, os.path.join(savedir, 'Spatial', 'StimDur_Hist_AllSessions_%dsessions' % nSessions + '.png'), format='png')
...
save_fig(fig, os.path.join(savedir, 'Spatial', 'RunSpeed_Space_Heatmap_ExampleSessions.png'), format='png')
...
plt.tight_layout()
save_fig(fig, os.path.join(savedir, 'Spatial', 'RunSpeed_Space_Heatmap_Average.png'), format='png')
...
save_fig(fig, os.path.join(savedir,'BehaviorData','RunSpeed_vs_LickRate.png'), format = 'png')
...
save_fig(fig, os.path.join(savedir,'Performance','VideoME_Outcome_%s' % sessions[sesidx].sessiondata['session_id'][0] + '.png'), format = 'png')
...
save_fig(fig, os.path.join(savedir, 'Spatial', 'LogisticDecodingPerformance_LickResponse_engaged_stimonly.png'), format='png')
...
#Save figure:
save_fig(fig, os.path.join(savedir, 'Spatial', 'Lickrate_Hist_DNSessions_%dsessions' % nSessions + '.png'), format='png')
...
for ises in range(nSessions):
    ...
    save_fig(fig, os.path.join(savedir,'Spatial','LickRaster','LickRaster_%s' % sessions[ises].sessiondata['session_id'][0] + '.png'), format = 'png')
...
# save_fig(fig, os.path.join(savedir,'Performance','LickRate_Psy_%s' % sessions[sesidx].sessiondata['session_id'][0] + '.png'), format = 'png')
...
save_fig(fig, os.path.join(savedir,'Performance','RunSpeed_Outcome_%s' % sessions[sesidx].sessiondata['session_id'][0] + '.png'), format = 'png')
fig = plot_run_corridor_psy(sessions[sesidx].trialdata,sessions[sesidx].runPSTH,bincenters)
save_fig(fig, os.path.join(savedir,'Performance','RunSpeed_Psy_%s' % sessions[sesidx].sessiondata['session_id'][0] + '.png'), format = 'png')
...
protocol                = ['DM']
sessions,nSessions      = filter_sessions(protocol,load_behaviordata=True,has_pupil=False)
sessiondata             = pd.concat([ses.sessiondata for ses in sessions]).reset_index(drop=True)
...
# sessions[sesidx].lickPSTH[-1,:] = 0
fig = plot_lick_corridor_psy(sessions[sesidx].trialdata,sessions[sesidx].lickPSTH,bincenters)
save_fig(fig, os.path.join(savedir,'Performance','LickRate_Max_%s' % sessions[sesidx].sessiondata['session_id'][0] + '.png'), format = 'png')
fig = plot_lick_corridor_outcome(sessions[sesidx].trialdata,sessions[sesidx].lickPSTH,bincenters)
save_fig(fig, os.path.join(savedir,'Performance','LickRate_Outcome_%s' % sessions[sesidx].sessiondata['session_id'][0] + '.png'), format = 'png')
...
fig = plot_psycurve([sessions[sesidx]])
fig = plot_psycurve(sessions)
save_fig(fig, os.path.join(savedir,'Psychometric','Psy_%s.png' % sessions[sesidx].session_id))

fig = plot_psycurve(sessions,filter_engaged=True)
save_fig(fig, os.path.join(savedir,'Psychometric','Psy_%s_Engaged.png' % sessions[sesidx].session_id))
...
save_fig(fig, os.path.join(savedir,'Psychometric','LickRate_vs_RunningSpeed_%s.png' % sessions[sesidx].session_id))
