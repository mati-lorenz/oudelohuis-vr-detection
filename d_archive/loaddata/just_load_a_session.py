...
sessions,nSessions = filter_sessions(protocols = protocol,only_session_id=['LPE12385_2024_06_16']) #no behav or ca data
...
sessions,nSessions = load_sessions(protocol[0],session_list,load_behaviordata=True,load_calciumdata=True,
                                   load_videodata=True,calciumversion='deconv')
